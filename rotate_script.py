...
def rotate_image(image_path, angle=90):
    ...
    # Obtenir le répertoire, le nom de base du fichier et son extension
    ...
    # Enregistrer la nouvelle image rotatée
    iio.imwrite(new_image_path, rotated)

    # Retourner le chemin de la nouvelle image
    print(new_image_path) # Afficher sur stdout pour que PHP puisse le récupérer
...
if __name__ == "__main__":
    ...
    angle = float(sys.argv[2]) if len(sys.argv) > 2 else 90 # 90 par défaut si non fourni
